...
Here, the second version of the enviroment which contains 20 identical agents is used when trainning， While the first version of the enviroment which contains one agent is used when playing. 
